...
class BackendTester:
    ...
    def run_all_tests(self):
        ...
        tests = [
            ...
            # Enhanced authentication system tests
            self.test_enhanced_registration_with_tokens,
            self.test_enhanced_login_with_tokens,
            self.test_token_refresh_endpoint,
            self.test_token_type_validation,
            self.test_refresh_token_database_storage,
            self.test_token_expiration_handling,
            self.test_refresh_token_error_scenarios,
            self.test_access_token_extended_expiration,
            ...
            # NEW: Upload approach profile picture tests
            self.test_upload_profile_picture_file,
            self.test_upload_profile_picture_validation,
            self.test_upload_profile_picture_authentication,
            self.test_get_profile_picture_info,
            self.test_serve_profile_picture_file,
            self.test_delete_uploaded_profile_picture,
            self.test_profile_integration_with_uploads,
            self.test_image_processing_and_optimization,
